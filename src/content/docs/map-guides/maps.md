...
## What is different about each map?

| Map | Setting | Officially highlighted traits |
| --- | --- | --- |
...
Across revealed maps, official materials and the PAX East 2026 demo emphasize:

- **Civilian play:** searching vehicles (including car trunks), finding items, barricading houses, hiding, and using the environment while escorting or convincing residents.
- **Michael play:** stalking, light manipulation, and using darkness for mobility—see /michael-myers/abilities/.
- **Multiplayer format:** 1 Michael Myers vs 4 Civilians on these maps. See /multiplayer/how-multiplayer-works/.

Escape options, item pools, and objective routing are designed to vary between matches according to IllFonic's multiplayer overview—but **exact spawn locations and optimal routes are not published**.

## Launch verification pending

Do not treat the following as confirmed pre-launch facts:

- Exact phone, car key, or item spawn locations
- Best escape route or map meta
- Fixed objective paths or resident spawn tables
- Final lighting or power-grid behavior per block

These require hands-on verification after Advance Access (September 4, 2026) and full release (September 8, 2026).
