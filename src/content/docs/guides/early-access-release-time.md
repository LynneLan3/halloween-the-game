...
facts:
  ...
  -
    label: Advance Access eligibility
    value: "Confirmed for Digital Deluxe pre-orders only (official preorder page). Standard edition pre-orders do not list gameplay Early Access."
  -
