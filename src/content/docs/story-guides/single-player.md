...
changeSummary: "LAUNCH_UPDATE — first-clear focus, Patch 1.0.1 status, and challenge ownership de-duplication."
eyebrow: Story Mode
facts:
  -
    label: Perspective
...
- It fixed Story Mode NPC struggle scaling.
- It addressed interaction-prompt disappearance and a grabbed-unaware-victim alert bug.
