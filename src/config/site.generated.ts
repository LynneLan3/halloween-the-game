...
export const siteConfig: GameConfig = {
	...
	portal: {
		...
		statusItems: [
			{
				label: "Current patch",
				value: "Patch 1.0.1 — September 8, 2026",
			},
			{
				label: "Release state",
				value: "Out now — full release is live",
			},
			{
				label: "Start with",
				value: "Arrest Michael, Chapter 4 Challenge 6, escapes, or queue help",
			},
		],
		popularQuestions: [
			{
				label: "How do you arrest or detain Michael?",
				href: "/how-to-arrest-michael-myers/",
				context: "Follow the verified police-pressure, handcuff, Detain Michael, and result-screen sequence.",
			},
			{
				label: "How do you complete Chapter 4 Challenge 6?",
				href: "/challenges/chapter-4-challenge-6/",
				context: "Use the movie-accurate Chapter 4 route and verify the result screen; Patch 1.0.1 outliers may remain.",
			},
			{
				label: "How do Civilian escape routes work?",
				href: "/multiplayer/how-to-escape/",
				context: "Use the live match objective and keep exact capacity, spawns, and fixed routes bounded.",
			},
			{
			...
			{
				label: "What changed in Patch 1.0.1?",
				href: "/updates/",
				context: "Current patch highlights and bounded known-issue status, linked to each gameplay owner.",
			},
			{
	...
	categories: [
		...
		},
		{
			id: "progression",
			label: "Progression",
			description: "Civilian perks, Michael builds, progression tracks, and role-based picks.",
			icon: "rocket",
			order: 5,
		...
		},
		{
			id: "guides",
			label: "Guides",
			description: "Task-focused answers for players who need help right now.",
			icon: "rocket",
			order: 1,
			image: "covers/halloween-gameplay-1.jpg",
		},
		{
			id: "live-updates",
			label: "Updates",
			description: "Latest patch status and verified known-issue boundaries.",
			icon: "information",
			order: 7,
	...
	pages: [
		...
		},
		{
			...
			role: "core",
			assetType: "article",
			intents: ["halloween-updates", "halloween-patch-1-0-1", "halloween-known-issues"],
			relations: [
				{
	...
	routes: [
		...
		},
		{
			id: "progression",
			eyebrow: "Progression",
			title: "Progression & Builds",
			description: "Civilian perks, Michael builds, progression tracks, and role-based picks.",
			href: "/routes/progression/",
			visual: "covers/progression/po-perk-cards.jpg",
			pages: [
				{
					pageId: "progression-perks",
					href: "/progression-perks/",
			...
			fastAnswers: [
				{
					question: "How do progression and perks work?",
					answer: "Four XP tracks feed Perk Cards, Perk Decks, Michael abilities, and other unlocks.",
					pageId: "progression-perks",
					href: "/progression-perks/",
				},
				{
				...
				},
				{
					...
					answer: "Use the dated editorial Civilian picks as role guidance, not objective game fact.",
					pageId: "civilian-tier-list",
					href: "/civilian-tier-list/",
				},
			],
		...
		},
		{
			...
			eyebrow: "Reference",
			title: "Reference",
			description: "Characters, PC requirements, platform status, editions, and other lookup pages.",
			...
			pages: [
				...
				{
					pageId: "australia-release-status",
				...
				},
				{
					...
					description: "Halloween: The Game released Tuesday, September 8, 2026 at 9:00 AM PT. Digital Deluxe Early Access began September 4, 2026 at 9:00 AM PT.",
				...
				{
					pageId: "physical-collectors-edition",
					href: "/physical-collectors-edition/",
