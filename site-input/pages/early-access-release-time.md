...
3. Whether buying a Deluxe upgrade after the preorder window (or purchasing a post-launch Deluxe SKU) grants the same Sep 4 Advance Access is Not Announced by the publisher. For a comparison of editions and upgrade options, see the [edition comparison]({{page:standard-vs-deluxe-upgrade}}).
