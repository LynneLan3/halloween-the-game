...
See also the [Michael Myers hub]({{page:michael-myers-hub}}) for the broader killer overview.
...
- [Multiplayer hub]({{page:multiplayer-hub}})
- [How multiplayer works]({{page:multiplayer-how-it-works}})
