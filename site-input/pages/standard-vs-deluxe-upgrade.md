...
For the official preorder page and storefront upgrade SKU see the publisher pages via the launch hub: {{hub}} and the Deluxe upgrade SKU referenced here: {{page:standard-vs-deluxe-upgrade}}.
