...
- **Play on Sep 4 Advance Access:** Digital Deluxe **pre-order** before launch (confirmed path). Post-preorder Deluxe purchase or launch upgrade Advance Access is **Not Announced** — see {{page:early-access-release-time}}.
...
- **Standard is enough for core multiplayer:** All 10 Standard Civilians and full online 1v4 multiplayer are in the base game — {{page:characters-hub}}.
...
- **Steam Deck compatibility:** Not verified pre-launch. Anti-cheat middleware is cited in secondary sources but **not confirmed** on the live Steam anti-cheat field — {{page:steam-deck}}.

- **Australia per-SKU availability:** Base game RC stands; Deluxe IARC listing is provisional — {{page:australia-release-status}}. Last Verified: 2026-09-02.

- **Official match timer:** No published rule; ~12-minute footage is observational — {{page:match-length-timer}}.
