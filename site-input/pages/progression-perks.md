...
![Official Halloween: The Game character customization and loadout UI](../../../assets/covers/progression/po-customization.jpg)  
...
- Exact card effects, deck construction, named perks, and balance changes belong to {{page:perk-cards}}. The full roster and numeric values remain unconfirmed.

For practical role-based recommendations, see [Best Perks & Builds]({{page:best-perks-builds}}). This decision guide is separate from this page's progression and Perk system reference.
...
- [Playable Characters — Hub]({{page:characters-hub}})  
- [Multiplayer: How It Works]({{page:multiplayer-how-it-works}})  
- [Guide Hub]({{hub}})

Perk ownership
- This page owns progression tracks, unlocks, prestige, and the brief Perk Points → Perk Cards → Perk Decks flow.
- For the card list, deck rules, named perks, and Patch 1.0.2 balance changes, use {{page:perk-cards}}.
