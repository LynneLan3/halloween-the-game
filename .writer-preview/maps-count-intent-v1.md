...
| --- | --- | --- | --- |
| [Haddonfield Heights]({{page:maps-haddonfield-heights}}) | Residential neighborhood | Myers house; Lampkin Lane; water tower; Strode house (neighborhood landmark) | [Haddonfield Heights guide]({{page:maps-haddonfield-heights}}) |
| [Haddonfield Town Center]({{page:maps-haddonfield-town-center}}) | Downtown / commercial district | Nichols Hardware; A-Side Music Store; Hill Garden Center; Patty's Pub | [Town Center guide]({{page:maps-haddonfield-town-center}}) |
| [Orange Grove Estates]({{page:maps-orange-grove-estates}}) | Upscale residential / multi-level homes | Doyle residence; Wallace residence; playground / neighborhood park | [Orange Grove Estates guide]({{page:maps-orange-grove-estates}}) |
| [East Haddonfield]({{page:maps-east-haddonfield}}) | Rural / agricultural / industrial outskirts | Rabbit in Red Lounge; Phelps Garage; Midwest Feed Company; farmland / silos | [East Haddonfield guide]({{page:maps-east-haddonfield}}) |

Haddonfield Heights

![Haddonfield Heights residential neighborhood on Halloween: The Game](src/assets/covers/maps/haddonfield-heights-01.jpg)  
...
- For detailed layout and gameplay notes, see the full [Haddonfield Heights guide]({{page:maps-haddonfield-heights}}).

Haddonfield Town Center

![Nichols Hardware on Haddonfield Town Center map](src/assets/covers/maps/town-center-nichols-hardware.jpg)  
...
- See the [Town Center guide]({{page:maps-haddonfield-town-center}}) for landmark-level notes and official media.

Orange Grove Estates

![Playground on Orange Grove Estates map](src/assets/covers/maps/orange-grove-playground.jpg)  
...
- Visit the [Orange Grove Estates guide]({{page:maps-orange-grove-estates}}) for the developer flythrough and landmark detail.

East Haddonfield

![Rabbit in Red Lounge neon exterior on East Haddonfield](src/assets/covers/maps/east-haddonfield-rabbit-lounge.jpg)  
...
- East Haddonfield is also confirmed to appear in at least one single-player chapter; do not infer the other three maps correspond 1:1 to story chapters. See the [East Haddonfield guide]({{page:maps-east-haddonfield}}) for official screenshots and notes.
...
- Official multiplayer materials are available; see the multiplayer overview for format and mode details: [Multiplayer overview]({{page:multiplayer-how-it-works}}).
