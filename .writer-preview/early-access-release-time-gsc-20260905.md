...
- The publisher has not published a single universal preload schedule. Preload availability and file sizes vary by storefront and platform. Check the [preload download status guide]({{page:preload-download-status}}) for the latest platform-specific preload notes and links.
