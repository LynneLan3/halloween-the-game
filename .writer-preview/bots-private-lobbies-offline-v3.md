...
- Story Mode is a dedicated single‑player campaign experience distinct from both offline bot play and private AI matches. For details on the story campaign itself, see [{{page:single-player-hub}}]({{page:single-player-hub}}).
